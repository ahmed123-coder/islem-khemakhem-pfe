/*
  ...
  - You are about to drop the column `requestedDate` on the `Reservation` table. All the data in the column will be lost.
...
*/
-- AlterTable
ALTER TABLE "Reservation" DROP COLUMN "requestedDate",

      ...
      <div className="bg-white rounded-[2.5rem] shadow-2xl w-full max-w-md mx-4 p-10 animate-in zoom-in-95" onClick={e => e.stopPropagation()}>
        ...
        <div className="grid grid-cols-1 gap-4">
          <button 
            ...
            className="flex items-center gap-6 p-6 border-2 border-blue-100 rounded-[2rem] hover:border-blue-600 hover:bg-blue-50/50 transition-all group text-left shadow-sm hover:shadow-xl font-bold"
          >
          ...
          <button 
            ...
            className="flex items-center gap-6 p-6 border-2 border-green-100 rounded-[2rem] hover:border-green-600 hover:bg-green-50/50 transition-all group text-left shadow-sm hover:shadow-xl font-bold"
          >
            <div className="w-14 h-14 bg-white rounded-2xl flex items-center justify-center text-3xl shadow-sm group-hover:scale-110 transition-transform">🏢</div>
            <div className="flex-1">

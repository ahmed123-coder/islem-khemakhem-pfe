...
export default function ClientDashboard() {
  const [stats, setStats] = useState<Stats>({ totalMissions: 0, activeMissions: 0, completedMissions: 0, pendingMissions: 0 })
  ...
  return (
    <div className="p-8">
      <div className="mb-8">
        ...
        <p className="text-gray-600 mt-2">Track your missions and progress</p>
      </div>
        ...
        <div className="bg-white p-6 rounded-lg shadow">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-3xl font-bold text-gray-800 mt-2">{stats.pendingMissions}</p>
            </div>
      ...
      <div className="bg-white rounded-lg shadow p-6">
        <div className="flex justify-between items-center mb-4">
          <h2 className="text-xl font-bold text-gray-800">My Missions</h2>
          <Link href="/client/missions" className="text-blue-600 hover:text-blue-800 text-sm font-medium">
            View All
          </Link>
        </div>
            ...
            <Link key={mission.id} href={`/missions/${mission.id}`}>
              <div className="flex items-center justify-between p-4 border border-gray-200 rounded-lg hover:border-blue-500 transition">
                <div className="flex-1">
                  ...
                  <p className="text-sm text-gray-500">Consultant: {mission.consultant.name}</p>
                </div>
